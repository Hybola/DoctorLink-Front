...
export default function ProviderProfileImageEdit({ currentProfileImage }) {
    ...
    return (
        <dialog id="ProviderProfileImageEdit" className="modal">
            <input
                type="file"
                className="hidden"
                ref={inputEl}
            ...
            <form method="dialog" className="modal-box  ml-[250px] bg-base-100">
                ...
                <div className="flex flex-col h-[300px] justify-between">
                    ...
                    <div className="w-full flex justify-center items-center ">
                        <div className="w-[150px] h-[150px] bg-info  shadow-lg flex justify-center items-center ">
                            <img
                                src={
                                    file
