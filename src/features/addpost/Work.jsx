...
export default function Work({ post, p }) {
    ...
    return (
        <div className="w-full flex flex-col rounded-lg p-4  mb-6 gap-6">
            <div className=" flex  w-full  font-semibold text-3xl justify-between ">
                <div className="flex gap-4 items-center">
                    <div>{post?.title}</div>
                </div>
            </div>
            <div className="flex font-thin text-sm gap-1">
                <div> post date: </div>
                <div>{dateTimeTH(Date.now())}</div>
            </div>

            <div className=" flex w-full  h-[30px]  gap-2 items-end">
            ...
            {p == 'PartTime' ? (
                <>
                    ...
                    <div className="flex w-full  h-[30px]  gap-2 items-center">
                        <span>
                            <SalaryIcon />
                        </span>
                        <span>{post?.wage}</span>
                ...
                <>
                    ...
                    <div className="flex  w-full  h-[24px] gap-2 items-center">
                        <span>
                            <SalaryIcon />
                        </span>
            ...
            <div className="flex  w-full  h-[22px]  gap-2 items-center">
                <span>
                    <Phone />
                </span>
