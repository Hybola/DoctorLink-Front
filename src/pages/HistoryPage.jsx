...
export default function History() {
    ...
    const [inactiveChk, setInactiveChk] = useState('checked')
    ...
    const hdlInactiveOnChange = () => {
        console.log('hdlInactiveOnChange')
        inactiveChk == 'checked'
            ? setInactiveChk('')
            : setInactiveChk('checked')
        console.log(objFilter)
    }
    ...
    return (
        <div className=" bg-gray-200  w-[100vw] h-[100vh] flex flex-col justify-start items-center">
            <div className="bg-blue-400 w-[80%] mt-3 p-2 flex flex-row justify-between items-center">
                <div className=" flex flex-row items-center  gap-5 ">
                    {/* <DatePicker
                        ...
                        locale="th"
                        formatInputText={(value) => value.format('DD/MM/YYYY')}
                        format="DD/MM/YYYY"
                    />
            ...
            <div className="bg-red-200 w-[80%] h-[650px] mb-3 p-2">
                <h1>history</h1>
